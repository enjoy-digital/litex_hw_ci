...
litex_ci_configs = {
    ...
    "arty_vexriscv_32_bit_wishbone" : LiteXCIConfig(
        ...
        --with-spi-sdcard \
        --with-usb",
        software_command = f"cd linux && python3 make.py --cpu-type=vexriscv --xlen 32 --with-usb --soc-json=../build_arty_vexriscv_32_bit_wishbone/soc.json --linux-clean --linux-build --linux-generate-dtb --linux-prepare-tftp",
        setup_command    = "",
        exit_command     = "",
        tty              = "/dev/ttyUSB1",
    ...
    "arty_vexriscv_32_bit_axi_lite" : LiteXCIConfig(
        ...
        --with-spi-sdcard \
        --with-usb",
        software_command = f"cd linux && python3 make.py --cpu-type=vexriscv --xlen 32 --with-usb --soc-json=../build_arty_vexriscv_32_bit_axi_lite/soc.json --linux-clean --linux-build --linux-generate-dtb --linux-prepare-tftp",
        setup_command    = "",
        exit_command     = "",
        tty              = "/dev/ttyUSB1",
        test_keywords    = test_keywords,
    ...
    "arty_vexriscv_32_bit_axi" : LiteXCIConfig(
        ...
        --with-spi-sdcard \
        --with-usb",
        software_command = f"cd linux && python3 make.py --cpu-type=vexriscv --xlen 32 --with-usb --soc-json=../build_arty_vexriscv_32_bit_axi/soc.json --linux-clean --linux-build --linux-generate-dtb --linux-prepare-tftp",
        setup_command    = "",
        exit_command     = "",
        tty              = "/dev/ttyUSB1",
        test_keywords    = test_keywords,
